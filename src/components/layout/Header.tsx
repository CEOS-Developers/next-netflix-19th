  ...
  return (
    <header className="flex items-center justify-center h-16 px-6 bg-transparent text-white mt-4 mr-2">
      <div className="flex items-center justify-between w-full max-w-screen-lg">
        ...
        <span
          className={
            activeMenu === 'tvshows' ? 'text-white font-semibold' : 'text-gray-400 hover:text-white cursor-pointer'
          }
        ...
        <span
          className={
            activeMenu === 'movies' ? 'text-white font-semibold' : 'text-gray-400 hover:text-white cursor-pointer'
          }
        ...
        <span
          className={
            activeMenu === 'mylist' ? 'text-white font-semibold' : 'text-gray-400 hover:text-white cursor-pointer'
          }
